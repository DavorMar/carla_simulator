...
class Buffer:
    def __init__(self, buffer_capacity=30_000, batch_size=64):
...
if __name__ == "__main__":
    ...
    for ep in range(total_episodes):
        try:
            env.reset()
            _, _, _, prev_state = env.step(env.route_points,spawn=True)
            episodic_reward = 0
            frame = 0
            ...
            while True:
                ...
                _, reward, done, state = env.step(env.route_points, action)
                print(action[0], reward, state[-3:])
